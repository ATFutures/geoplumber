...
```{r, echo=FALSE, fig.align='center', out.width="50%", fig.cap="`geoplumber` concept for those who do not want to read the text."}
knitr::include_graphics("man/figures/geoplumber-concept.png")
```
