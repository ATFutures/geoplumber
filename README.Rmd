...
```
<center><a href='https://www.cdrc.ac.uk/'>CDRC</a> London traffic data on `geoplumber`. </center>
...
1. Basic HTML input elements for data exploration (thinking baseweb). This is Shiny's widgets in React (as Angular/Vue would be unrealistic in 0.1)
2. Basic sidepanel to use (1) in.

Future can be different. That should suffice to get goeplumber hitting CRAN.
