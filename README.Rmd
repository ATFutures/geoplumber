...
It supports [React](https://reactjs.org/) frontends at present (it may support other frontend frameworks such as Veu in the future) and geographic data, building on [`sf`](https://github.com/r-spatial/sf).
